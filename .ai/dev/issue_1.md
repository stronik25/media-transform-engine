...
- Verify the Clip Engine workflow end-to-end on the main branch after acceptance.
- Confirm that outputs, artifacts, and metadata fields are correct and consistent.
- If verification is successful, propose the next concrete step for development.
