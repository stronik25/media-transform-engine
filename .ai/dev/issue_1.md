...
https://github.com/stronik25/media-transform-engine/issues/1

## Goal
- Verify the Clip Engine functionality end-to-end on the main branch after successful acceptance.
- Confirm that outputs, artifacts, and metadata fields generated by the Clip Engine are correct.
